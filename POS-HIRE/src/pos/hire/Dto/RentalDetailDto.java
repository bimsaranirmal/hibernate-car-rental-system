...
public class RentalDetailDto {
    ...
    public RentalDetailDto(String rentalId, Double AdvancedPay, Double Balance, Double PerDayRent, Double Refund, Date RentalEndDate, Date RentalStartDate, Boolean Returned, Double TotalAmount, String carId, String custId) {
    ...
    public String toString() {
        return "RentalDetailDto{" + "rentalId=" + rentalId + ", AdvancedPay=" + AdvancedPay + ", Balance=" + Balance + ", PerDayRent=" + PerDayRent + ", Refund=" + Refund + ", RentalEndDate=" + RentalEndDate + ", RentalStartDate=" + RentalStartDate + ", Returned=" + Returned + ", TotalAmount=" + TotalAmount + ", carId=" + carId + ", custId=" + custId + '}';
    }
